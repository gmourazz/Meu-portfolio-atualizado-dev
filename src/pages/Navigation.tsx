    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center py-3 sm:py-4">
          ...
          {/* Theme toggle — COLADO NA DIREITA */}
          <div className="ml-auto flex items-center">
            ...
            >
              {theme === "dark" ? (
                <Sun className="w-5 h-5 text-[#E9DFD2]" />
              ) : (
                <Moon className="w-5 h-5 text-[#5B4636]" />
              )}
            </motion.button>
          </div>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              id="mobile-nav"
              className="md:hidden fixed left-0 right-0 top-[56px] sm:top-[64px] z-50 px-4 pb-5"
